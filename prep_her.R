...
exportLotteryRDBES("herringlottery_H13.csv", her2018, herringSelectionProb2018, exportHerringSS, 2018, "National Routine", "Norwegian HER > 15 m", generateTargetAssemblageSpecified("SPF"))
